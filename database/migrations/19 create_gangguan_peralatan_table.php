...
{
    /**
     * Function untuk membuat tabel Gangguan peralatan
     *
     * @return tabel Gangguan peralatan di database
     */
    public function up(): void
    {
        Schema::create('gangguan_peralatan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('gangguan_peralatan');
    }
};
