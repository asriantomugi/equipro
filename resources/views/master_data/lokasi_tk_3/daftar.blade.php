            ...
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-success btn-sm float-right" 
                   href="{{ route('master_data.lokasi_tk_3.tambah.form') }}" 
...
@foreach ($daftar as $satu)
                    <tr class="table-condensed">
                      ...
                      <td><center>{{ strtoupper($satu->getLokasiTk2->kode) }} - {{ strtoupper($satu->getLokasiTk2->nama) }}</center></td>
...
-->
                        <center>
                          <a class="btn btn-info btn-sm" 
                             href="{{ route('master_data.lokasi_tk_3.edit.form', $satu->id) }}"
                             role="button"
  ...
  @if (session()->has('notif'))
    ...
    @elseif(session()->get('notif') == 'item_null')
      $(document).Toasts('create', {
          class: 'bg-danger',
          title: 'Error!',
          body: 'Data Lokasi Tingkat III tidak ditemukan'
        })
    @endif
  @endif
</script>
...
<script type="text/javascript">
  function detail(id){
    ...
    $.ajax({
        url : "{{ route('master_data.lokasi_tk_3.detail') }}",
        type: "POST",
        data : {id: id},
        success: function(data){
          ...
          if(data.created_by != null){
              ...
              row += "<tr><th>Dibuat Pada</th><td>:</td><td>"+ data.lokasi_tk_3.created_at_formatted +"</td></tr>";
          }else{
          ...
          if(data.updated_by != null){
              ...
              row += "<tr><th>Update Terakhir Pada</th><td>:</td><td>"+ data.lokasi_tk_3.updated_at_formatted +"</td></tr>";
          }else{
