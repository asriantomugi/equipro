            ...
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-success btn-sm float-right" 
                   href="{{ route('master_data.perusahaan.tambah.form') }}" 
...
-->
                        <center>
                          <a class="btn btn-info btn-sm" 
                             href="{{ route('master_data.perusahaan.edit.form', $satu->id) }}"
                             role="button"
  ...
  @if (session()->has('notif'))
    ...
    @elseif(session()->get('notif') == 'item_null')
      $(document).Toasts('create', {
          class: 'bg-danger',
          title: 'Error!',
          body: 'Data perusahaan tidak ditemukan'
        })
    @endif
  @endif
</script>
...
<script type="text/javascript">
  function detail(id){
    ...
    $.ajax({
        url : "{{ route('master_data.perusahaan.detail') }}",
        type: "POST",
        data : {id: id},
        success: function(data){
          ...
          if(data.created_by != null){
              ...
              row += "<tr><th>Dibuat Pada</th><td>:</td><td>"+ data.perusahaan.created_at_formatted +"</td></tr>";
          }else{
          ...
          if(data.updated_by != null){
              ...
              row += "<tr><th>Update Terakhir Pada</th><td>:</td><td>"+ data.perusahaan.updated_at_formatted +"</td></tr>";
          }else{
