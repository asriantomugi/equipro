          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">FORM TAMBAH LOKASI TINGKAT II</h3>
              </div>
              <!-- /.card-header -->

<!-- form start -->
<form class="form-horizontal needs-validation" 
      action="{{ route('master_data.lokasi_tk_2.tambah') }}"
      method="post" 
      novalidate>
@csrf
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select name="lokasi_tk_1" 
                          class="form-control" 
                          required>
                    <option value="">- Pilih -</option>
@foreach ($lokasi_tk_1 as $satu)
                    <option value="{{ $satu->id }}" {{ old('lokasi_tk_1') == $satu->id ? 'selected' : '' }}>{{ $satu->kode }} - {{ $satu->nama }}</option>
@endforeach
                  </select>
