    ...
    $.ajax({
        ...
        success: function(data){
          ...
          if(data.created_by != null){
              ...
              row += "<tr><th>Dibuat Pada</th><td>:</td><td>"+ data.jenis_alat.created_at_formatted +"</td></tr>";
          }else{
          ...
          if(data.updated_by != null){
              ...
              row += "<tr><th>Update Terakhir Pada</th><td>:</td><td>"+ data.jenis_alat.updated_at_formatted +"</td></tr>";
          }else{
