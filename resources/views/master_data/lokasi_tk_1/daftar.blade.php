  ...
  @if (session()->has('notif'))
    @if (session()->get('notif') == 'tambah_sukses')
      $(document).Toasts('create', {
          class: 'bg-success',
          title: 'Sukses!',
          body: 'Lokasi Tingkat I baru telah berhasil ditambahkan'
        })
    @elseif(session()->get('notif') == 'edit_sukses')
      $(document).Toasts('create', {
          class: 'bg-success',
          title: 'Sukses!',
          body: 'Data Lokasi Tingkat I telah berhasil diubah'
        })
    @elseif(session()->get('notif') == 'tambah_gagal')
      $(document).Toasts('create', {
          class: 'bg-danger',
          title: 'Error!',
          body: 'Gagal menambahkan Lokasi Tingkat I baru'
        })
    @elseif(session()->get('notif') == 'edit_gagal')
      $(document).Toasts('create', {
          class: 'bg-danger',
          title: 'Error!',
          body: 'Gagal mengubah data Lokasi Tingkat I'
        })
    ...
    $.ajax({
        ...
        success: function(data){
          ...
          var row = '<div class="modal-header">';
              row += '<h4 class="modal-title">Detail Lokasi Tingkat I</h4>';
              ...
              row += "<tr><th>Kode</th><td>:</td><td>"+ data.lokasi_tk_1.kode.toUpperCase(); +"</td></tr>";  
              row += "<tr><th>Nama</th><td>:</td><td>"+ data.lokasi_tk_1.nama.toUpperCase(); +"</td></tr>";            
              
          if(data.lokasi_tk_1.status == 1){
          ...
          if(data.created_by != null){
              ...
              row += "<tr><th>Dibuat Pada</th><td>:</td><td>"+ data.lokasi_tk_1.created_at_formatted +"</td></tr>";
          }else{
          ...
          if(data.updated_by != null){
              ...
              row += "<tr><th>Update Terakhir Pada</th><td>:</td><td>"+ data.lokasi_tk_1.updated_at_formatted +"</td></tr>";
          }else{
        ...
        {
            alert('Gagal menampilkan detail Lokasi Tingkat I');
        }
    });
}
</script>
