...
<form class="form-horizontal needs-validation" 
      action="{{ route('master_data.fasilitas.edit') }}"
      method="post" 
      novalidate>
@csrf
              ...
              <div class="card-body">
                ...
                <input type="text" name="id" value="{{ $fasilitas->id }}" hidden>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" 
                           name="kode" 
                           class="form-control"
                           value="{{ strtoupper(old('kode', $fasilitas->kode ?? '')) }}"
                           required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" 
                           name="nama" 
                           class="form-control"
                           value="{{ strtoupper(old('nama', $fasilitas->nama ?? '')) }}"
                           required>
              ...
              <div class="card-footer">
                <a class="btn btn-default btn-sm" 
                   href="{{ route('master_data.fasilitas.daftar') }}" 
                   role="button">Batal</a>
