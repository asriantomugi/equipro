    ...
    $.ajax({
        ...
        success: function(data){
          ...
          var row = '<div class="modal-header">';
              row += '<h4 class="modal-title">Detail Fasilitas</h4>';
              ...
              row += "<tr><th>Kode</th><td>:</td><td>"+ data.fasilitas.kode.toUpperCase(); +"</td></tr>";  
              row += "<tr><th>Nama</th><td>:</td><td>"+ data.fasilitas.nama.toUpperCase(); +"</td></tr>";            
              
          if(data.fasilitas.status == 1){
        ...
        {
            alert('Gagal menampilkan detail fasilitas');
        }
    });
}
</script>
