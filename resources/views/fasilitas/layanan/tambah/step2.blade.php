...
@endforeach                   
    ...
    <!-- javascript untuk menampilkan modal untuk edit data peralatan -->
    <script type="text/javascript">
      function edit(peralatan_id, layanan_id) {
        //alert(id);
        $('#isi_modal_edit').empty();;
          ...
          var html = '<div class="modal-header">';
              ...
              html += '<form action="{{route('fasilitas.layanan.peralatan.hapus')}}" method="post">';
              html += '@csrf';
              html += '<div class="modal-body">';
              html += '<input type="text" name="peralatan_id" value="'+peralatan_id+'" hidden>';
              html += '<input type="text" name="layanan_id" value="'+layanan_id+'" hidden>';
              ...
              html += '<label class="col-sm-3 col-form-label required">Kode</label>';
              html += '<div class="col-sm-9">';
              html += '<input type="text" name="kode" class="form-control" value="" disabled>';
              html += '</div>';
              html += '</div>';
              html += '<div class="form-group row">';
              html += '<label class="col-sm-3 col-form-label required">Nama</label>';
              html += '<div class="col-sm-9">';
              html += '<input type="text" name="nama" class="form-control" value="'+peralatan+'" disabled>';
              html += '</div>';
              html += '</div>';
