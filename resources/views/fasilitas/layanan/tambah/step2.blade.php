        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-success btn-sm float-right" 
                                data-toggle="modal" 
                                data-target="#modalPeralatan"><i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;Tambah
                        </button>
                    </div>
                    <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        ...
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
            @foreach ($layanan->daftarPeralatanLayanan as $satu)
                                <tr class="table-condensed">
                                <td></td>
            ...
            @endforeach                   
                    ...
                    <div class="card-footer">
                        ...
                        href="{{ route('fasilitas.layanan.tambah.step1.back.form', ['id' => $layanan->id]) }}"
    ...
    @if (session()->has('notif'))
        ...
        @elseif(session()->get('notif') == 'item_null')
            ...
            $(document).Toasts('create', {
                class: 'bg-danger',
                title: 'Error!',
                body: 'Daftar peralatan masih kosong',
                autohide: true,
                delay: 3000
            })
        @endif
...
<script type="text/javascript">
    ...
    $('#filter-form').on('submit', function (e) {
        ...
        $.post('{{ route('fasilitas.layanan.peralatan.filter') }}', // url('/fasilitas/layanan/peralatan/filter') 
            $(this).serialize(), 
            function (data) {
    ...
    $('#daftar-peralatan-tabel').on('click', '.btn-tambah-peralatan', function () {
        ...
        $.post('{{ route('fasilitas.layanan.peralatan.tambah') }}', { // url('/fasilitas/layanan/peralatan/tambah')
            _token: '{{ csrf_token() }}',
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data.peralatan.status == 1){
                row += "<tr><th>Status</th><td>:</td><td><span class='badge bg-success'>AKTIF</span></tr>";
            }else{
