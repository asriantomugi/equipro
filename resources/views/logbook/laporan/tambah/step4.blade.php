  ...
  <div class="container-fluid">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">FORM PENGGANTIAN</h3>
      </div>
            ...
            @foreach ($peralatanLama as $index => $peralatan)
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-6">
                  ...
                  <input type="hidden" name="peralatan_baru[{{ $index }}][id]" id="pb_id_{{ $index }}">
                  @foreach(['kode', 'nama', 'merk', 'tipe', 'model', 'serial_number', 'status', 'kondisi'] as $field)
                    <div class="form-group row mb-2">
                      <label class="col-sm-2"></label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="peralatan_baru[{{ $index }}][{{ $field }}]" id="pb_{{ $field }}_{{ $index }}" readonly>
                      </div>
                    </div>
                  @endforeach
                </div>
