                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="jenis" 
                                ...
                                <option value="1" {{ $laporan->jenis == config('constants.jenis_laporan.gangguan_peralatan') ? 'selected' : '' }}>GANGGUAN PERALATAN</option>
                                <option value="2" {{ $laporan->jenis == config('constants.jenis_laporan.gangguan_non_peralatan') ? 'selected' : '' }}>GANGGUAN NON PERALATAN</option>
                            </select>
