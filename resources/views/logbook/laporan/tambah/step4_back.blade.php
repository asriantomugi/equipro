          ...
          @if ($laporan->jenis == 1 && $jenis_tindaklanjut === 0) {{-- 0 = penggantian --}}
            ...
            @if ($loop->iteration > 1) <hr> @endif
              @php
                ...
                // Ambil data penggantian yang tersimpan untuk peralatan ini
                $dataTersimpan = isset($dataPenggantianTersimpan) && $dataPenggantianTersimpan->has($peralatan->id) 
                    ? $dataPenggantianTersimpan->get($peralatan->id) 
                    : null;
                $peralatanBaru = $dataTersimpan ? $dataTersimpan->peralatanBaru : null;
              @endphp
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="hidden" name="penggantian[{{ $idx }}][peralatan_baru_id]" 
                         ...
                         value="{{ $peralatanBaru ? $peralatanBaru->id : '' }}">
                    ...
                    <div class="form-group row mb-2">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control"
                               ...
                               id="pb_{{ $f }}_{{ $idx }}" 
                               value="{{ $peralatanBaru ? $peralatanBaru->$f : '' }}"
                               readonly>
                      </div>
                    </div>
                  @endforeach
                  ...
                  <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control"
                             ...
                             id="pb_status_{{ $idx }}" 
                             value="{{ $peralatanBaru ? ($peralatanBaru->status == 1 ? 'Aktif' : 'Tidak Aktif') : '' }}"
                             readonly>
                    </div>
                  </div>
