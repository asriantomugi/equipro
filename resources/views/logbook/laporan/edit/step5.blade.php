      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              @if($laporan->jenis == 1 && isset($penggantian) && $penggantian->count() > 0)
              <table class="table table-bordered table-striped table-sm">
                <thead>
                  <tr>
                    <th><center>No</center></th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <center>
                        @if($item->tindaklanjut->kondisi == 1 || $item->tindaklanjut->kondisi == '1')
                          <span class="badge bg-success">BEROPERASI</span>
                        @else
                          <span class="badge bg-danger">GANGGUAN</span>
                        @endif
              ...
              @elseif(isset($tindaklanjut) && $tindaklanjut)
              <table class="table table-bordered table-striped table-sm">
                <thead>
                  <tr>
                    <th><center>No</center></th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <center>
                        @if($tindaklanjut->kondisi == 1 || $tindaklanjut->kondisi == '1')
                          <span class="badge bg-success">BEROPERASI</span>
                        @else
                          <span class="badge bg-danger">GANGGUAN</span>
                        @endif
