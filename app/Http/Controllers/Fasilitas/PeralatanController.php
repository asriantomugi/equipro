    ...
    public function tambah(Request $request)
    {
        ...
        try{
            ...
            $peralatan = Peralatan::create([
                ...
                'no_sertifikasi' => strtoupper($request->no_sertifikasi),
                'terbit_sertifikasi' => $request->terbit_sertifikasi,
                'exp_sertifikasi' => $request->exp_sertifikasi,
                'lembaga_sertifikasi' => strtoupper($request->lembaga_sertifikasi),
                'sewa' => $request->sewa,
